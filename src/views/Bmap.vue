                ...
                series: [
                    {
                        ...
                        // encode用于定制tooltip展示的数据 比如在我们的数据testPoint中是三个数据 该数组第二项是销售额也就是我们需要展示的数据
                        encode: {
                            value: 2
                        },
                        // 这个配置是返回 散点的大小
